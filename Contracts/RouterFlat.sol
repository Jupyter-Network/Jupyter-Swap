...
// File: contracts/V1/Core/JupyterLiquidityTokenV1.sol
...
// File: contracts/V1/Core/JupyterCoreHelperV1.sol
...
// File: contracts/V1/Core/IJupyterCoreV1.sol
...
// File: contracts/V1/Core/JupyterCoreV1.sol
...
// File: contracts/V1/Router/IJupyterRouterV1.sol
...
// File: contracts/TestTokens/IWETH.sol
...
// File: contracts/V1/Router/JupyterRouterV1.sol
...
contract JupyterRouterV1 is IJupyterRouterV1 {
        ...
        returns (uint256, uint256)
    {
        ...
        //--------------DEV
    function swapTokens(address _fromToken,address _toToken,uint256 _fromAmount, uint256 _toMinAmount)public{
        ...
        //From
        uint256 wbnbMinAmount = token0Wbnb.getToken0AmountFromToken1Amount(_fromAmount);
        uint256 wbnbAmount = token0Wbnb.swapToken1ToToken0(_fromAmount,wbnbMinAmount, address(this));

        //To
        uint256 toAmountMin = token1Wbnb.getToken1AmountFromToken0Amount(wbnbAmount);
        //require(toAmountMin >= _toMinAmount,"Price changed");
        uint256 receivedAmount = token1Wbnb.swapToken0ToToken1(wbnbAmount, _toMinAmount, address(this));
        //require(receivedAmount >= _toMinAmount,"Price changed");
        IERC20(_toToken).safeTransfer(msg.sender,receivedAmount);
    }

    function getTokenToTokenQuote(address _fromToken,address _toToken,uint256 _fromAmount) public view returns(uint256) { 
        require(_fromToken != wbnb,"Function does not swap bnb");
        JupyterCoreV1 token0Wbnb = _existingPair(_fromToken);
        require(address(token0Wbnb) != address(0x00),"Token not listed");
        JupyterCoreV1 token1Wbnb = _existingPair(_toToken);
        ...
        //From
        uint256 wbnbAmount = token0Wbnb.getToken0AmountFromToken1Amount(_fromAmount);
